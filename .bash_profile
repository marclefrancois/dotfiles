...
export PATH="~/Library/Marger/bin:~/Library/Python/3.6/bin:$HOME/Library/Android/sdk/platform-tools:$HOME/Library/Android/sdk/tools:$HOME/bin:$PATH:/Applications/Visual Studio Code.app/Contents/Resources/app/bin:$ANDROID_HOME:/Users/marclefrancois/Library/Python/3.7/bin:~/Documents/GIT/bellmedia-vidi-ios/build-tools/Framework";
